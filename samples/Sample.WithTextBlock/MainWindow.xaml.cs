...
public partial class MainWindow : Window
{
    ...
    private readonly TextBlock[] _priceBlocks = new TextBlock[12];
    ...
    private void BuildTiles()
    {
        for (int i = 0; i < 12; i++)
        {
            ...
            // Standard TextBlock — each Text change triggers InvalidateMeasure(),
            // which walks the visual tree upward causing a full layout pass.
    ...
    private void OnTick(object? sender, EventArgs e)
    {
        ...
        _updateCount++;
        StatusText.Text = $"Control: TextBlock  |  Updates: {_updateCount}  |  Rate: 10/sec";
    }
}
